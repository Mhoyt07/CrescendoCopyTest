...
public class ThreeNoteRightAuto extends SequentialCommandGroup {
  /** Creates a new ThreeNoteRightAuto. */
  public ThreeNoteRightAuto(SwerveDrive driveSwerve, Joystick driverL, Joystick driverR, Shooter noteShooter, Intake inTake, Pivot shooterPivot) {
